...
- Cloudflare Pages + architecture-friendly static pages (`docs/`)
...
- Supporting architecture docs: `README.ko.md`, `README.en.md`, `docs/ops/RUNBOOK.md`, `docs/deployment/CLOUDFLARE_PAGES.md`
