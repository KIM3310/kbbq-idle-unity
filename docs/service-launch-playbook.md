# Service Launch Playbook - kbbq-idle-unity
...
- **First commercial action:** Playable game launch with ads, in-app purchases, publisher pitch, or community support path.
