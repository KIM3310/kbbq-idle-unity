...
Unity game prototype packaged as a playable product surface with monetization and retention experiments.
...
| Area | Position |
| --- | --- |
| Target buyer | product teams and niche end users |
| Paid wedge | freemium app path, team package, or sponsored pilot |
