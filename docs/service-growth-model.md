# Service Growth Model - kbbq-idle-unity
...
| Field | Decision |
|---|---|
| Service type | Game proof and playable distribution |
| Primary reader or buyer | Players, publishers, or game prototype reviewers if spun out separately. |
| Wedge | Playable prototype polish and retention instrumentation. |
