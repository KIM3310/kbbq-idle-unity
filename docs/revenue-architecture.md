# Revenue Architecture - kbbq-idle-unity
...
| Layer | Decision |
| --- | --- |
| Target buyer / user | casual idle game player, WebGL portal visitor, or streamer/community audience |
| Productized offer | Korean BBQ idle game with progression, leaderboard, events, and collectible content |
| First paid SKU | cosmetic packs, ad-free mode, event boosts, and supporter bundle |
| Free lead magnet | free WebGL build on Pages/itch.io |
| Paid expansion | optional IAP/cosmetics, web sponsorship, and seasonal asset packs |
| Data / workflow moat | progression economy, event telemetry, leaderboard behavior, and owned Korean food theme assets |
| Private inquiry | https://kim3310-doeon-kim-portfolio.pages.dev/?offer=kbbq-idle-unity&inquiry=consumer-prototype-customization#private-inquiry |
...
| Repo-specific launch path | Cloudflare Pages or itch.io WebGL hosting, Firebase/Supabase leaderboard, Workers API for events, OpenGameArt/Kenney/Freesound only for license-safe asset expansion |
...
2. Route confidential and commercial requests through the [central Cloudflare D1 private inquiry](https://kim3310-doeon-kim-portfolio.pages.dev/?offer=kbbq-idle-unity&inquiry=consumer-prototype-customization#private-inquiry); keep public GitHub issues limited to non-confidential product discussion.
