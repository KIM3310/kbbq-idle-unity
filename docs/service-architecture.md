...
- **Lane:** Game proof and playable distribution
- **Primary buyer:** Players, publishers, or game prototype reviewers if spun out separately
- **First motion:** Playable prototype polish and retention instrumentation

## Recommended Architecture

WebGL build on Cloudflare Pages or itch.io, optional backend for saves/leaderboards, analytics for retention only.
...
- Cloudflare Pages or itch.io
- optional PlayFab/Supabase
...
- separate brand from enterprise portfolio
- age/privacy review
- no aggressive service launch mechanics
