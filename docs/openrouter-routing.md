...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `mistralai/mistral-small-2603` | Optional NPC/event copy, player support summaries, and live-ops content drafts. |
...
OPENROUTER_HTTP_REFERER=https://kbbq-idle-unity.pages.dev
OPENROUTER_APP_TITLE=kbbq-idle-unity
```
